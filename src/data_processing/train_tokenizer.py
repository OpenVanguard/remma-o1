...
def train_tokenizer_with_checkpoints():
    # Configuration
    input_file = "data/processed/c4_subset.txt"
    checkpoint_dir = "data/tokenizers/checkpoints"
    final_tokenizer_path = "data/tokenizers/remma_tokenizer_v1.json"
    batch_size = 70000000  # Lines per batch
    vocab_size = 50000
